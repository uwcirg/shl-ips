...
export const DEMO_WARNING = env('VITE_DEMO_WARNING', import.meta.env.VITE_DEMO_WARNING);

export const API_BASE = env('VITE_API_BASE', import.meta.env.VITE_API_BASE);

export const INTERMEDIATE_FHIR_SERVER_BASE = env('VITE_INTERMEDIATE_FHIR_SERVER_BASE', import.meta.env.VITE_INTERMEDIATE_FHIR_SERVER_BASE);
...
export const VERSION_STRING = env('VITE_APP_VERSION_STRING', import.meta.env.VITE_APP_VERSION_STRING);

export const AUTH_URL = env('VITE_AUTH_URL', import.meta.env.VITE_AUTH_URL);
export const AUTH_CLIENT_ID = env('VITE_AUTH_CLIENT_ID', import.meta.env.VITE_AUTH_CLIENT_ID);
export const AUTH_REDIRECT_URI = env('VITE_AUTH_REDIRECT_URI', import.meta.env.VITE_AUTH_REDIRECT_URI);
export const AUTH_SILENT_REDIRECT_URI = env('VITE_AUTH_SILENT_REDIRECT_URI', import.meta.env.VITE_AUTH_SILENT_REDIRECT_URI);
export const AUTH_POST_LOGOUT_URI = env('VITE_AUTH_POST_LOGOUT_URI', import.meta.env.VITE_AUTH_POST_LOGOUT_URI);
...
export const SOF_HOSTS = [
  ...
  //   clientId: env('VITE_EPIC_HIMSS_CLIENT_ID', import.meta.env.VITE_EPIC_HIMSS_CLIENT_ID),
  //   note: "zwei / epic"
  // },
  // {
  //   id: "ecw-himss",
  ...
  //   clientId: env('VITE_ECW_HIMSS_CLIENT_ID', import.meta.env.VITE_ECW_HIMSS_CLIENT_ID),
  ...
  //   clientId: env('VITE_EPIC_CLIENT_ID', import.meta.env.VITE_EPIC_CLIENT_ID),
  //   note: "cwilson / tokay"
  // },
  // {
  ...
  //   clientId: env('VITE_EPIC_CTHON_2025_09_CLIENT_ID', import.meta.env.VITE_EPIC_CTHON_2025_09_CLIENT_ID),
  //   note: "jwjips / epic"
  // },
  {
    id: "epic",
  ...
  { 
    ...
    clientId: env('VITE_CERNER_CLIENT_ID', import.meta.env.VITE_CERNER_CLIENT_ID),
...
export const EPIC_CLIENT_ID = env('VITE_EPIC_CLIENT_ID', import.meta.env.VITE_EPIC_CLIENT_ID);
export const CERNER_CLIENT_ID = env('VITE_CERNER_CLIENT_ID', import.meta.env.VITE_CERNER_CLIENT_ID);
...
if (env('VITE_ACENTRA_CLIENT_ID', import.meta.env.VITE_ACENTRA_CLIENT_ID)) {
  CARIN_HOSTS.push({
    id: "acentra",
    name: "Acentra HCA Test System",
    url: "https://sb.fhir.mhbapp.com/pa/api/v1",
    clientId: env('VITE_ACENTRA_CLIENT_ID', import.meta.env.VITE_ACENTRA_CLIENT_ID),
    scope: "openid launch/patient patient/*.read",
    note: "sbuser001 / Acentra-sb$2024",
    section: "applehealth"
  });
}
if (env('VITE_UNITED_CLIENT_ID', import.meta.env.VITE_UNITED_CLIENT_ID)) {
  CARIN_HOSTS.push({
    id: "united",
    name: "UnitedHealthcare Test System",
    url: "https://flex.optum.com/fhir/sandbox/R4",
    clientId: env('VITE_UNITED_CLIENT_ID', import.meta.env.VITE_UNITED_CLIENT_ID),
...
if (env('VITE_MOLINA_CLIENT_ID', import.meta.env.VITE_MOLINA_CLIENT_ID)) {
  CARIN_HOSTS.push({
    id: "molina",
    name: "Molina Test System",
    url: "https://api.interop.molinahealthcare.com/sandbox/patientaccess",
    clientId: env('VITE_MOLINA_CLIENT_ID', import.meta.env.VITE_MOLINA_CLIENT_ID),
    // scope: "openid launch/patient patient/List.read patient/MedicationKnowledge.read patient/Patient.read patient/Coverage.read patient/Condition.read patient/Immunization.read patient/MedicationDispense.read patient/MedicationRequest.read patient/Observation.read patient/Procedure.read patient/Encounter.read patient/ExplanationOfBenefit.read patient/AllergyIntolerance.read patient/CarePlan.read patient/CareTeam.read patient/Device.read patient/DiagnosticReport.read patient/DocumentReference.read patient/Goal.read",
...
if (env('VITE_AETNA_CLIENT_ID', import.meta.env.VITE_AETNA_CLIENT_ID)) {
  CARIN_HOSTS.push({
    id: "aetna",
    name: "Aetna Test System",
    url: "https://vteapif1.aetna.com/fhirdemo/v2/patientaccess",
    clientId: env('VITE_AETNA_CLIENT_ID', import.meta.env.VITE_AETNA_CLIENT_ID),
...
if (env('VITE_HUMANA_CLIENT_ID', import.meta.env.VITE_HUMANA_CLIENT_ID)) {
  CARIN_HOSTS.push({
    id: "humana",
    name: "Humana Test System",
    url: "https://sandbox-fhir.humana.com/api",
    clientId: env('VITE_HUMANA_CLIENT_ID', import.meta.env.VITE_HUMANA_CLIENT_ID),
    // scope: "openid launch/patient patient/Patient.read patient/Coverage.read patient/ExplanationOfBenefit.read",
...
if (env('VITE_BLUE_BUTTON_CLIENT_ID', import.meta.env.VITE_BLUE_BUTTON_CLIENT_ID)) {
  CARIN_HOSTS.push({
    id: "bluebutton",
    name: "Blue Button 2.0 Test System",
    url: "https://sandbox.bluebutton.cms.gov/v3/fhir",
    // url: "https://sandbox.bluebutton.cms.gov/v2/fhir",
    clientId: env('VITE_BLUE_BUTTON_CLIENT_ID', import.meta.env.VITE_BLUE_BUTTON_CLIENT_ID),
    scope: "openid launch/patient patient/Patient.read patient/Coverage.read patient/ExplanationOfBenefit.read",
    note: "BBUser09001 / PW09001!"
  });
}
if (env('VITE_CAREFIRST_CLIENT_ID', import.meta.env.VITE_CAREFIRST_CLIENT_ID)) {
  CARIN_HOSTS.push({
    id: "carefirst",
    ...
    clientId: env('VITE_CAREFIRST_CLIENT_ID', import.meta.env.VITE_CAREFIRST_CLIENT_ID),
    note: "Credentials provided"
  });
}

// Connectathon Testing Servers //////////////////////////////////////////////////////////////////////////////
if (env('VITE_CPCDS_CLIENT_ID', import.meta.env.VITE_CPCDS_CLIENT_ID)) {
  CARIN_HOSTS.push({
    id: "cpcds",
    name: "CPCDS Test System",
    url: "https://cpcds-server.lantanagroup.com/fhir",
    clientId: env('VITE_CPCDS_CLIENT_ID', import.meta.env.VITE_CPCDS_CLIENT_ID),
    scope: "openid fhirUser launch/patient patient/*.read",
    note: "Patient1 / password"
  });
}
if (env('VITE_INFERNO_CLIENT_ID', import.meta.env.VITE_INFERNO_CLIENT_ID)) {
  CARIN_HOSTS.push({
    id: "inferno",
    name: "Inferno Test Suite",
    url: "https://inferno.healthit.gov/suites/custom/c4bb_v200_client/fhir",
    clientId: env('VITE_INFERNO_CLIENT_ID', import.meta.env.VITE_INFERNO_CLIENT_ID),
    scope: 'openid fhirUser launch/patient patient/*.read',
    note: "Credentials provided"
  });
}
if (env('VITE_ONYX_CLIENT_ID', import.meta.env.VITE_ONYX_CLIENT_ID)) {
  CARIN_HOSTS.push({
    id: "onyx",
    name: "ONYX",
    url: "https://api-dmdh-alpha.safhir.io/v1/api/carin-bb/",
    clientId: env('VITE_ONYX_CLIENT_ID', import.meta.env.VITE_ONYX_CLIENT_ID),
...
if (env('VITE_DELOITTE_CLIENT_ID', import.meta.env.VITE_DELOITTE_CLIENT_ID)) {
  CARIN_HOSTS.push({
    id: "deloitte",
    name: "Deloitte’s State Medicaid Agency",
    url: "https://deloitte.connectathons.com/",
    clientId: env('VITE_DELOITTE_CLIENT_ID', import.meta.env.VITE_DELOITTE_CLIENT_ID),
    scope: 'openid fhirUser launch/patient patient/*.read',
    note: "norma_sparks / UserPass123!"
  });
}
if (env('VITE_SMILECARINBB_CLIENT_ID', import.meta.env.VITE_SMILECARINBB_CLIENT_ID)) {
  CARIN_HOSTS.push({
    id: "smilecarinbb",
    name: "Smile CDR",
    url: "https://cdr-qa.p2p.azure.smilecdr.com/payer-fhir/",
    clientId: env('VITE_SMILECARINBB_CLIENT_ID', import.meta.env.VITE_SMILECARINBB_CLIENT_ID),
    scope: 'openid fhirUser launch/patient patient/*.read',
...
export const BEARER_AUTHORIZATION = {
  'EpicHIMSS': env('VITE_EPIC_CLIENT_ID', import.meta.env.VITE_EPIC_CLIENT_ID)
}
...
const SYSTEM_URL = env('VITE_SYSTEM_URL', import.meta.env.VITE_SYSTEM_URL) || (typeof window !== 'undefined' ? new URL(window.location.href).toString() : undefined);
export const VIEWER_BASE = env('VITE_VIEWER_BASE', import.meta.env.VITE_VIEWER_BASE) || ((SYSTEM_URL ?? "") + '/ips#');
export const SHOW_VIEWER_DEMO = env('VITE_SHOW_VIEWER_DEMO', import.meta.env.VITE_SHOW_VIEWER_DEMO);
