  ...
  <Row>
    <Accordion>
      ...
      <AccordionItem>
        ...
        <p class="info-paragraph">
          Begining in 2021, WA Verify made it easy for people receiving COVID-19 vaccinations in
          Washington State to access and share that information using SMART Health Card QR codes. WA
          Health Summary builds on the ideas and technologies of WA Verify, which was used by almost
          two million people from 2021-2023
        </p>

        <p class="info-paragraph">
          Now, using SMART Health Links, WA Health Summary enables personally-controlled access to,
        ...
        <p class="info-paragraph">
          WA Health Summary lets people access, augment, and electively share their own health data
      ...
      <AccordionItem>
        ...
        <p class="info-paragraph">
          ...
          choosing. WA Health Summary uses the secure, patient-controlled SMART Health Link (SHL)
